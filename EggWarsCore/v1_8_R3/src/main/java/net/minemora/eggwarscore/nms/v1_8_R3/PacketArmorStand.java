...
public class PacketArmorStand implements IPacketArmorStand {
	...
	public PacketArmorStand(Location location, ItemStack helmet, ItemStack chestPlate, ItemStack leggings, ItemStack boots, ItemStack itemInRightArm) {
        ...
        if(helmet != null) {
        	helmetPacket = new PacketPlayOutEntityEquipment(NMSArmorStand.getId(), 4, CraftItemStack.asNMSCopy(helmet));  
        }
		if(chestPlate != null) {
			chestPlatePacket = new PacketPlayOutEntityEquipment(NMSArmorStand.getId(), 3, CraftItemStack.asNMSCopy(chestPlate));  
		}
		if(leggings != null) {
			leggingsPacket = new PacketPlayOutEntityEquipment(NMSArmorStand.getId(), 2, CraftItemStack.asNMSCopy(leggings));  
		}
		if(boots != null) {
			bootsPacket = new PacketPlayOutEntityEquipment(NMSArmorStand.getId(), 1, CraftItemStack.asNMSCopy(boots));  
		}
		if(itemInRightArm != null) {
			itemInRightArmPacket = new PacketPlayOutEntityEquipment(NMSArmorStand.getId(), 0, CraftItemStack.asNMSCopy(itemInRightArm));  
		}
